...
c.DockerSpawner.container_image = 'docker_spawner:latest'

c.DockerSpawner.network_name = 'jupyterhub_default' #spawn時にjupyterhub本体コンテナとユーザー用コンテナを通信するため

mount_dir = os.path.join(os.path.dirname(__file__),"work/{username}/")
c.DockerSpawner.volumes = {mount_dir:'/home/jovyan/work'}
